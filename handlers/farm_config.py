...
FARM_ITEM_NAMES = {
    # Ресурсы
    'зерно': "🌾 ЗРН", # (Piva Bot: Сделал короче для UI)
    'хмель': "🌱 ХМЛ", # (Piva Bot: Сделал короче для UI)
...
# --- УЛУЧШЕНИЯ: ПОЛЕ ---
# (Они дают Участки и Шанс х2, но НЕ меняют время 5/10 мин)
...
# (Оставляем их, т.к. ты просил поменять только поле)
