...
# (Импорт из .shop УДАЛЕН)

# --- ИНИЦИАЛИЗАЦИЯ ---
farm_router = Router()

# --- СЛОВАРИ "ПОНЯТНЫХ" НАЗВАНИЙ, РЕЦЕПТОВ, ПРАЙС-ЛИСТОВ (УДАЛЕНЫ) ---
# (Они теперь в farm_config.py)


# --- ✅✅✅ CALLBACKDATA ФАБРИКИ (Без Изменений) ✅✅✅ ---
...
# --- ✅✅✅ ГЛАВНАЯ ФУНКЦИЯ: "ДАШБОРД СТАТИСТИКИ" (Без Изменений) ✅✅✅ ---
...
# --- 9. Меню: "Пакетная Варка" ➔ Выбор Кол-ва ---
...
# --- 13. Меню: "Подтверждение" Улучшения ---
